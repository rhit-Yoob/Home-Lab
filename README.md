...
## Overview
Personal home lab server built on Debian 13 (Bookworm) Linux. 
Built to develop real world skills in DevOps, SysAdmin, and 
Cloud Engineering in preparation for industry certifications.
...
2. [Initial Configuration](setup/02-initial-config.md)
3. [SSH Setup](setup/03-ssh-setup.md)
4. [Docker Installation](setup/04-docker-install.md)
